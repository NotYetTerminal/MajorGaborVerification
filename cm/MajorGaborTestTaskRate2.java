...
//
//public class MajorGaborTestTaskRate2 {
//    // Base variables commonly used
//    ArrayList<Period> baseReducedPeriods = new ArrayList<>() {{
//        add(new Period(7, 10));
//    }};
//    ArrayList<Period> calculateBaseReducedPeriods = new ArrayList<>() {{
//        add(new Period(7, 10));
//        add(new Period(4, 5));
//    }};
...
//    }};
//    ArrayList<Period> calculateBaseNormalPeriods = new ArrayList<>() {{
//        add(new Period(10, 12));
